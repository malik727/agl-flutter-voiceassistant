...
class VoiceAgentServiceClient extends $grpc.Client {
  ...
  static final _$recognizeVoiceCommand = $grpc.ClientMethod<$0.RecognizeControl, $0.RecognizeResult>(
  ...
  static final _$executeVoiceCommand = $grpc.ClientMethod<$0.ExecuteInput, $0.ExecuteResult>(
  ...
  $grpc.ResponseFuture<$0.RecognizeResult> recognizeVoiceCommand($async.Stream<$0.RecognizeControl> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$recognizeVoiceCommand, request, options: options).single;
  }

  $grpc.ResponseFuture<$0.ExecuteResult> executeVoiceCommand($0.ExecuteInput request, {$grpc.CallOptions? options}) {
...
abstract class VoiceAgentServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ExecuteResult> executeVoiceCommand_Pre($grpc.ServiceCall call, $async.Future<$0.ExecuteInput> request) async {
  ...
  $async.Future<$0.RecognizeResult> recognizeVoiceCommand($grpc.ServiceCall call, $async.Stream<$0.RecognizeControl> request);
  $async.Future<$0.ExecuteResult> executeVoiceCommand($grpc.ServiceCall call, $0.ExecuteInput request);
}
