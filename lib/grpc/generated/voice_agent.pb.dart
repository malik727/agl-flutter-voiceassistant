...
class RecognizeControl extends $pb.GeneratedMessage {
  ...
  factory RecognizeControl.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RecognizeControl.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecognizeControl', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecognizeControl copyWith(void Function(RecognizeControl) updates) => super.copyWith((message) => updates(message as RecognizeControl)) as RecognizeControl;
  ...
  static $pb.PbList<RecognizeControl> createRepeated() => $pb.PbList<RecognizeControl>();
  @$core.pragma('dart2js:noInline')
  static RecognizeControl getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecognizeControl>(create);
...
class ExecuteResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecuteResult', createEmptyInstance: create)
    ..e<ExecuteStatusType>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: ExecuteStatusType.EXEC_ERROR, valueOf: ExecuteStatusType.valueOf, enumValues: ExecuteStatusType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  ExecuteStatusType get status => $_getN(0);
  @$pb.TagNumber(1)
  set status(ExecuteStatusType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => clearField(1);
